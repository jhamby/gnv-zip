...
$ proc_file = f$parse( proc, , , "name") + f$parse( proc, , , "type")
$ cmd_file = f$search( "sys$disk:[...]''proc_file'")
$ if arch .eqs. "VAX"
$ then
$    ! Fix an issue with NFS served files, must trim the version.
$    proc = f$element( 0, ";", proc)
$    cmd_file = f$element( 0, ";", cmd_file)
$ endif
$ proc_dev = f$parse( proc, , , "device")
$ proc_fid = f$file_attributes( proc, "fid")
$ cmd_fid = ""
$ if cmd_file .nes. "" then cmd_fid = f$file_attributes( cmd_file, "fid")
$ if cmd_fid .eqs. proc_fid
$ then
$     ! If the command file is on the original default device, then
$     ! we want to use the original default directory
$     ! The device needs to be set to sys$disk: in the case that the
$     ! default directory is a search list.
$     proc_dev = "sys$disk:"
$     proc_directory = f$parse( cmd_file, , , "directory")
$ else
$     ! We have to assume that we can find the main distribution relative
$     ! based on this command file.
$     proc_dev = f$parse( proc, , , "device")
$     proc_directory = f$parse( proc, , , "directory")
$ endif
$!
$ proc_dir = proc_dev + proc_directory
...
$!
$ cc_incl = "sys$disk:[], sys$disk:[.vms]"
$ if (AES_WG .gt. 0) then cc_incl = cc_incl + ", sys$disk:[.aes_wg]"
$ lib_bzip2_opts = ""
$ if (IZ_BZIP2 .nes. "")
$ then
...
$             goto error
$         else
$             if f$search( "LIB_BZIP2:''bz2_olb'") .nes. ""
$             then
...
$                 else
$                     say ""
$                     say "Can't find ''gnv_libbz2'.  Can't link."
$                     goto error
$                 endif
$             endif
$         endif
...
$! Compile the sources.
$!
$     header_file = "sys$disk:[.szip]SzVersion.h"
$     header_file_nfs = "sys$disk:[.szip]$S$z$V$ersion.h"
$     if f$search(header_file) .eqs. ""
$     then
$         if f$search(header_file_nfs) .nes. ""
$         then
$             copy 'header_file_nfs' 'header_file'
$         endif
$     endif
$!
$     header_file = "sys$disk:[.szip]Ppmd8.h"
$     header_file_nfs = "sys$disk:[.szip]$P$pmd8.h"
$     if f$search(header_file) .eqs. ""
$     then
$         if f$search(header_file_nfs) .nes. ""
$         then
...
$     endif
$!
$     header_file = "sys$disk:[.szip]Ppmd8.c"
$     header_file_nfs = "sys$disk:[.szip]$P$pmd8.c"
$     if f$search(header_file) .eqs. ""
$     then
$         if f$search(header_file_nfs) .nes. ""
$         then
...
$     endif
$!
$     header_file = "sys$disk:[.szip]Ppmd8Enc.c"
$     header_file_nfs = "sys$disk:[.szip]$P$pmd8$E$nc.c"
$     if f$search(header_file) .eqs. ""
$     then
$         if f$search(header_file_nfs) .nes. ""
$         then
...
$     endif
$!
$     header_file = "sys$disk:[.szip]Ppmd.h"
$     header_file_nfs = "sys$disk:[.szip]$P$pmd.h"
$     if f$search(header_file) .eqs. ""
$     then
$         if f$search(header_file_nfs) .nes. ""
$         then
...
$     endif
$!
$     header_file = "sys$disk:[.szip]CpuArch.h"
$     header_file_nfs = "sys$disk:[.szip]$C$pu$a$rch.h"
$     if f$search(header_file) .eqs. ""
$     then
$         if f$search(header_file_nfs) .nes. ""
$         then
...
$     endif
$!
$     header_file = "sys$disk:[.szip]Types.h"
$     header_file_nfs = "sys$disk:[.szip]$T$ypes.h"
$     if f$search(header_file) .eqs. ""
$     then
$         if f$search(header_file_nfs) .nes. ""
$         then
...
$     cc_inc = "/nested_include=none"
$     if f$search( "sys$disk:[]szip.dir") .nes. ""
$     then
$         define/user decc$user_include sys$disk:[.szip]
$     endif
$     cc 'DEF_UNX' 'cc_inc' /object = [.'dest']ZIPUP.OBJ ZIPUP.C
